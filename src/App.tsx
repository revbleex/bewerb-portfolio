      ...
      <header className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 backdrop-blur-md border-b border-amber-500/20 text-white py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="w-80 h-96 bg-gray-800/60 rounded-2xl overflow-hidden shadow-2xl border-2 border-amber-500/30 hover:border-amber-500 transition-all duration-300 hover:shadow-amber-500/20">
              <img
                src="/PROFIL.GPJ.jpeg"
                alt="Profil"
